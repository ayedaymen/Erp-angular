...
const API_PRODUCTS_URL = '//localhost:8082/api/factures/afficherFactures';
// Real REST API
@Injectable()
export class ProductsService {
  ...
  // READ
  getAllProducts(): Observable<FactureModel[]> {
    return this.http.get<FactureModel[]>('//localhost:8082/api/factures/afficherFactures');
  }
  ...
  findProducts(queryParams: QueryParamsModel): Observable<QueryResultsModel> {
    ...
    const url = '//localhost:8082/api/factures/afficherFactures'+ '/find';
